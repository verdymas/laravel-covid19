                        ...
                        <form method="post" action="{{ route('kesehatan.update', $data->nik_wrg) }}"
                            ...
                            @if ($his->tgl_sls < date('Y-m-d'))
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">Pasien dinyatakan telah sembuh dari penyakit covid19</td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2">Pasien dinyatakan belum sembuh, dan masa isolasi diperpanjang kembali selama 2
                                        Minggu
                                    </td>
                                </tr>
                                <tr>
                            ...
                            @endif
                            @if ($data->stat_skt == 0 || $his->tgl_sls == date('Y-m-d'))
                                @if ($data->stat_skt == 0)
                                ...
                                <template x-if="st_skt == 2">
                                    ...
                                    @if ($kk_skt)
                                        <tr>
                                            ...
                                            <input value="{{ $kk_skt->jml_ban }}" type="hidden" name="jml" required
                                                readonly>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="text-truncate">
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="2" class="align-middle text-truncate">
                                                <span class="mr-2 font-weight-bold">|</span>
                                                Per Hari
                                            </td>
                                            <td class="w-25">
