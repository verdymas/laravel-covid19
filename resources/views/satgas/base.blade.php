...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('adminlte/plugins/tempusdominus-bootstrap-4/cs') }}s/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">{{ ucfirst(request()->segment(count(request()->segments()))) }}
                            </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
